...
if difficulty == "easy":
    ...
    initial_ball_speed = 0.3  # Hard mode has the fastest speed
...
ball.penup()
ball.goto(0, 0)
ball.dx = initial_ball_speed  # Ball movement in x direction based on difficulty
ball.dy = -initial_ball_speed  # Ball movement in y direction based on difficulty
...
# Function to reset ball with a speed increase
def reset_ball():
    global initial_ball_speed
    ball.goto(0, 0)
    initial_ball_speed += 0.02  # Increase the speed slightly each time a point is scored
    ball.dx = initial_ball_speed if ball.dx > 0 else -initial_ball_speed
    ball.dy = initial_ball_speed if ball.dy > 0 else -initial_ball_speed
